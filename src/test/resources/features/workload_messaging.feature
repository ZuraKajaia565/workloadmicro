# src/test/resources/features/workload_messaging.feature
Feature: Workload Message Processing
  ...
  Scenario: Successfully process a create workload message
  ...
  Scenario: Successfully process a delete workload message
