...
public class DtoTest {
  ...
  void trainerWorkloadResponse_GettersSettersWork() {
    ...
    TrainerWorkloadResponse.MonthSummaryDto monthDto =
        new TrainerWorkloadResponse.MonthSummaryDto();
    monthDto.setMonth(5);
    ...
    assertEquals(
        60, response.getYears().get(0).getMonths().get(0).getSummaryDuration());
  }
  ...
  void workloadUpdateRequest_AllArgsConstructor_GettersSettersWork() {
    ...
    WorkloadUpdateRequest.ActionType actionType =
        WorkloadUpdateRequest.ActionType.ADD;

    // Act with Constructor
    WorkloadUpdateRequest request =
        new WorkloadUpdateRequest(username, firstName, lastName, isActive,
    ...
    assertEquals(WorkloadUpdateRequest.ActionType.DELETE,
                 emptyRequest.getActionType());
  }
  ...
  void workloadUpdateRequest_ActionTypeEnum_HasCorrectValues() {
    ...
    assertEquals(WorkloadUpdateRequest.ActionType.ADD,
                 WorkloadUpdateRequest.ActionType.valueOf("ADD"));
    assertEquals(WorkloadUpdateRequest.ActionType.DELETE,
                 WorkloadUpdateRequest.ActionType.valueOf("DELETE"));
  }
}
